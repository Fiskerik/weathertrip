    ...
    <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === "ios" ? "padding" : undefined}>
      <ScrollView contentContainerStyle={styles.page} keyboardShouldPersistTaps="handled">
        <View style={styles.topBar}>
          ...
          <View style={styles.brandMark}><Sun size={22} color={colors.ink} strokeWidth={2.6} /><Route size={20} color={colors.green} strokeWidth={2.6} /></View>
        </View>
...
function ScreenHeader({ title, subtitle }: { title: string; subtitle: string }) { return <View style={styles.screenHeader}><Text style={styles.eyebrow}>WEATHERTRIP</Text><Text style={styles.screenTitle}>{title}</Text><Text style={styles.screenSubtitle}>{subtitle}</Text></View>; }
